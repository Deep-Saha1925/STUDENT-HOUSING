...
//    }
    ...
    public List<Property> searchProperties(String city, Double rent, String rentalType, String gender) {
        return propertyRepository.searchProperties(city, rent, rentalType, gender);
    }
